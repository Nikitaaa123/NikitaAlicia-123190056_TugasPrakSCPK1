function varargout = TugasPrak1(varargin)
% TUGASPRAK1 MATLAB code for TugasPrak1.fig
%      TUGASPRAK1, by itself, creates a new TUGASPRAK1 or raises the existing
%      singleton*.
%
%      H = TUGASPRAK1 returns the handle to a new TUGASPRAK1 or the handle to
%      the existing singleton*.
%
%      TUGASPRAK1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TUGASPRAK1.M with the given input arguments.
%
%      TUGASPRAK1('Property','Value',...) creates a new TUGASPRAK1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before TugasPrak1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to TugasPrak1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help TugasPrak1

% Last Modified by GUIDE v2.5 07-Apr-2021 15:39:22

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @TugasPrak1_OpeningFcn, ...
                   'gui_OutputFcn',  @TugasPrak1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before TugasPrak1 is made visible.
function TugasPrak1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to TugasPrak1 (see VARARGIN)

% Choose default command line output for TugasPrak1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes TugasPrak1 wait for user response (see UIRESUME)
% uiwait(handles.judul);


% --- Outputs from this function are returned to the command line.
function varargout = TugasPrak1_OutputFcn(hObject, eventdata, handles) 
...
function panjang_CreateFcn(hObject, ~, handles)
% hObject    handle to panjang (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user sdata (see GUIDATA)
